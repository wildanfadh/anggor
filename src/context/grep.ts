...
async function runSearchCommand(engine: SearchEngine, query: string, options: SearchOptions): Promise<SearchMatch[]> {
...
export async function searchInFiles(query: string, options: SearchOptions = {}): Promise<SearchResult> {
