...
export function checkCommandSafety(command: string, config: SafetyConfig): SafetyCheckResult {
 ...
 */
export function buildSafeEnv(env: NodeJS.ProcessEnv = process.env): Record<string, string> {
